...
public extension Chain where Base: UIView {
    ...
    /// 内容拉伸优先级
    @discardableResult
    func setContentHuggingPriority(_ priority: UILayoutPriority, for axis: NSLayoutConstraint.Axis) -> Chain {
    ...
    /// /// 内容压缩优先级
    @discardableResult
    func setContentCompressionResistancePriority(_ priority: UILayoutPriority, for axis: NSLayoutConstraint.Axis) -> Chain {
    ...
    /// 切圆角
    @discardableResult
    func roundedCorners(_ byRoundingCorners: UIRectCorner, _ cornerRadii: CGSize) -> Chain {
        base.layoutIfNeeded()
    ...
    @discardableResult
    func addSuperView(_ view: UIView) -> Chain {
        view.addSubview(base)
        return self
    }
    
    @discardableResult
    func snpMakeConstraints(_ constraintMaker: (ConstraintMaker) -> Void) -> Chain {
