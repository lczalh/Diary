...
class LCZWaveView: UIView {
    ...
    // 真实波浪颜色
    var realWaveColor: UIColor = cz_RgbColor(55, 153, 249,0.6)
    // 阴影波浪颜色
    var maskWaveColor: UIColor = cz_RgbColor(55, 153, 249, 0.3)
    // 波浪位置（默认是在下方）
