...
//        }
        ...
        self.customIrregularityStyle(tabBarController: tabBarController, viewController: v2, eSTabBarItemContentView: ExampleBouncesContentView(), title: "我听", image: UIImage(named: "find"), selectImage: UIImage(named: "find"))
