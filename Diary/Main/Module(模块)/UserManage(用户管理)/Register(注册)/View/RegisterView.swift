...
class RegisterView: DiaryBaseView {
    ...
    override func configUI() {
        ...
        accountTextField.font = cz_ConventionFont(size: 14)
        ...
        accountLineView.backgroundColor = cz_RgbColor(239, 240, 244, 1)
        ...
        codeButton.titleLabel?.font = cz_ConventionFont(size: 14)
        codeButton.backgroundColor = cz_RgbColor(239, 240, 244, 1)
        ...
        registerButton.backgroundColor = cz_RgbColor(239, 240, 244, 1)
        registerButton.layoutIfNeeded()
        let bezierPath = UIBezierPath(roundedRect: registerButton.bounds, byRoundingCorners: .allCorners, cornerRadii: CGSize(width: 40 * cz_ScreenSizeScale, height: 40 * cz_ScreenSizeScale))
