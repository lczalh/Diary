...
class NewsHomeListView: DiaryBaseView {
    ...
    override func configUI() {
        ...
        self.tableView.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: LCZPublicHelper.shared.getSafeAreaBottomHeight + LCZPublicHelper.shared.getTabbarHeight!, right: 0)
