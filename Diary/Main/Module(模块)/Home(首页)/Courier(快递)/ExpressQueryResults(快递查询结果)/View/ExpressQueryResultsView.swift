...
class ExpressQueryResultsView: DiaryBaseView {
    ...
    private func createTabelHeaderView() -> UIView {
        let tableHeaderView = UIView(frame: CGRect(x: 0, y: 0, width: cz_ScreenWidth!, height: 200))
        ...
        courierCompanyLeabel.font = cz_BoldFont(size: 18)
        ...
        courieNumberLabel.textColor = cz_RgbColor(161, 159, 161, 1)
        courieNumberLabel.font = cz_ConventionFont(size: 14)
        ...
        context.setStrokeColor(cz_RgbColor(213, 212, 214, 1).cgColor)
        ...
        timeConsumingLabel.font = cz_ConventionFont(size: 14)
