...
class SearchMovieViewController: DiaryBaseViewController {
    ...
    private lazy var searchMovieView: SearchMovieView = {
        let view = SearchMovieView(frame: CGRect(x: 0, y: 0, width: cz_ScreenWidth!, height: LCZPublicHelper.shared.getScreenHeight! - cz_StatusBarHeight! - cz_NavigationHeight! - cz_SafeAreaBottomHeight))
